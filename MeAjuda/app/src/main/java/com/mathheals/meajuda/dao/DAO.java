...
public abstract class DAO{
    ...
    private static final String URL_QUERY = "http://meajuda.000webhostapp.com/query.php";
    private static final String URL_CONSULT = "http://meajuda.000webhostapp.com/consult.php";
